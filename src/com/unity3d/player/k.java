            ...
            try {
                ...
                for (String str : packageInfo.requestedPermissions) {
                    try {
                        ...
                        j.Log(5, "Failed to get permission info for " + str + ", manifest likely missing custom permission declaration");
                        j.Log(5, "Permission " + str + " ignored");
                    }
                }
                ...
                j.Log(6, "Unable to query for permission: " + e3.getMessage());
            }
        }
    }
}
