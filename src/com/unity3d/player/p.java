...
public final class p extends Dialog implements TextWatcher, OnClickListener {
    private static int c = -570425344;
    private static int d = -1;
    private Context a = null;
    private UnityPlayer b = null;

    public p(Context context, UnityPlayer unityPlayer, String str, int i, boolean z, boolean z2, boolean z3, String str2) {
        super(context);
        this.a = context;
        this.b = unityPlayer;
    ...
    protected final View createSoftInputView() {
        ...
        anonymousClass2.setTextColor(c);
